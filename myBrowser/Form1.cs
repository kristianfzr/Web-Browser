...
namespace myBrowser
{
    public partial class frmMain : Form
    {
        ...
        private void btnForward_Click(object sender, EventArgs e) => webBrowser1.GoForward();

        private void btnGo_Click(object sender, EventArgs e) => webBrowser1.Navigate(cboLocation.Text);
